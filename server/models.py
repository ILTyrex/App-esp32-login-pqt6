...
class Evento(db.Model):
    ...
    tipo_evento = db.Column(db.Enum("LED_ON", "LED_OFF", "SENSOR_BLOQUEADO", "SENSOR_LIBRE", "RESET_CONTADOR"), nullable=False)
    detalle = db.Column(db.Enum("LED1", "LED2", "LED3", "SENSOR_IR", "CONTADOR"), nullable=False)
    origen = db.Column(db.Enum("APP", "CIRCUITO"), nullable=False)
